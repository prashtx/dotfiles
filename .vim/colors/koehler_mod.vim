...
hi StatusLineNC   term=reverse	ctermfg=white ctermbg=lightblue guifg=#f0f0f0 guibg=blue
hi Title		  term=bold  cterm=bold  ctermfg=darkmagenta  gui=bold	guifg=Magenta
"hi Visual		  term=reverse	cterm=reverse  guibg=White guifg=darkblue
hi Visual		  guifg=#203060
